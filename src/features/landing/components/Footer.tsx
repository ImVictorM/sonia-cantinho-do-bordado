...
import { artisan, brand, businessLocation, contact } from "../data/business";
import type { LandingPageSection } from "../landingPageSections";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="font-decorative text-lg text-primary-light">
              bordando sonhos com amor ✿
            </p>
            <p className="font-body text-sm text-white/60 leading-relaxed">
              Transformando linhas e tecidos em obras de arte há mais de 20
              anos.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/60 hover:bg-complement hover:text-white transition-all duration-300"
                aria-label="Facebook"
              >
                <svg
                  className="w-4 h-4"
