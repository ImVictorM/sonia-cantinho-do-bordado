...
import { brand, businessLocation, contact } from "../data/business";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 font-body text-sm text-white/60">
              <p>
                {toDisplayPhone(
                  contact.social.whatsapp.areaCode,
                  contact.social.whatsapp.number,
                )}
              </p>
              <p>{contact.email}</p>
              <p>
              ...
              <p>
                {businessLocation.businessHours.weekdays.start.hour} –{" "}
                {businessLocation.businessHours.weekdays.end.hour}
              </p>
            </div>
